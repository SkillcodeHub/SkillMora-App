class SavedJobsModel {
  bool? status;
  List<UserSavedJobs>? userSavedJobs;

  SavedJobsModel({this.status, this.userSavedJobs});

  SavedJobsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['userSavedJobs'] != null) {
      userSavedJobs = <UserSavedJobs>[];
      json['userSavedJobs'].forEach((v) {
        userSavedJobs!.add(new UserSavedJobs.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.userSavedJobs != null) {
      data['userSavedJobs'] =
          this.userSavedJobs!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class UserSavedJobs {
  ...
  UserSavedJobs(
      {this.id, this.clientDetails, this.userDetails, this.jobDetails});

  UserSavedJobs.fromJson(Map<String, dynamic> json) {
    id = json['id'];
